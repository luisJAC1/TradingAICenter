...
// Upstream Claw-Empire shipped bundled OAuth secrets for GitHub/Google login.
// TradingAICenter does not use claw-empire's OAuth flow — these are blanked out
// so the GitHub secret scanner doesn't flag the safety-net commit.
// If you ever need claw-empire OAuth login, set the OAUTH_*_* env vars.
