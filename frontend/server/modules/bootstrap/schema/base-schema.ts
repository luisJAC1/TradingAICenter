...
CREATE TABLE IF NOT EXISTS brain_bus_events (
...
CREATE INDEX IF NOT EXISTS idx_brain_bus_events_created_at ON brain_bus_events(created_at);
CREATE INDEX IF NOT EXISTS idx_brain_decisions_status ON brain_decisions(status, created_at);
